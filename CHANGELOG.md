...
- Apply incoming shared documents immediately while coalescing slow routing work into one serial queue. Preserve trailing changes and failed recovery scopes, and reuse already validated overrides during route-file publication.
